<template>
  <Board>
                ...
                <q-item-section>
                  <div class="row">
                    <div class="col-12 col-sm-6 q-mt-sm">
                      ...
                      <div class="col">{{ props.row.Units }}</div>
                    </div>
                    <div class="col-12 col-sm-6 q-mt-sm">
    ...
    <EditItemCategory ref="editor" @refresh="GetMaster" position="right" :mode="mode" />
  </Board>
</template>
...
export default {
  ...
  components: {
    ...
    EditItemCategory: defineAsyncComponent(() => import("./EditItemCategory.vue")),
  },
  setup() {
    ...
    const GetMaster = () => {
      api.ItemCategoryGetAll(dataOptions.value).then((response) => {
  ...
  mounted() {
    this.store.dispatch("UpdateBoardTitle", "Item Categories");
    this.GetMaster();
  },
};
</script>
